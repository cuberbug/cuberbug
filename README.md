...
Хобби: настольный риичи-маджонг.
...
[cuberbug-walls](https://github.com/cuberbug/cuberbug-walls).  
Сейчас это генерация таблицы с превью изображений.
Планируется увеличение гибкости генерации превью с добавлением дополнительных опций, а также отдельный модуль для генерации блока навигации.
